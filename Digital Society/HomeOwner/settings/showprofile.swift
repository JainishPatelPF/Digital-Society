...
class showprofile: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    func getLoginDataforUser()  {
        ...
        if arr.count == 1{
            ...
            //print(ownerID!)
            getDisc = arr[0]
            ownerID = (getDisc["manager_id"] as? NSString)?.integerValue
                ...
                do{
                    ...
                    DispatchQueue.main.async {
                        if jsonData.count == 1 {
                            ...
                            self.finalData1 = jsonData
                            storeLoginData(arrDisc: self.finalData1)
